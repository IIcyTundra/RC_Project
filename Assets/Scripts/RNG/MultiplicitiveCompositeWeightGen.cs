...
public class MutiplicitiveCompositeWeightGen : WeightGenerator
{
    ...
    public MutiplicitiveCompositeWeightGen(WeightGenerator[] weightGenerators)
    {
