...
public class CharacterController : MonoBehaviour {
    ...
    private void HandleWallGrab() {
        ...
        var grabbing = (_isAgainstLeftWall || _isAgainstRightWall) && Input.GetKey(KeyCode.LeftShift) && Time.time > _timeLastWallJumped + _wallJumpLock;
        
        float gScale = _grabbing ? 1f : 0f;
